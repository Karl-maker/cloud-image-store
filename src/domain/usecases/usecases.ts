...
import { FindManyDTO } from "../../application/interfaces/presenters/dtos/find.many.dto";
...
export abstract class Usecases<Entity extends Persistent, SortByKeys, FilterByKeys> {
