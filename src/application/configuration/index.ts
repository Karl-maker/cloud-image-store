...
export const S3_BUCKET_VIDEO_CONTENT_NAME_AWS = process.env.S3_BUCKET_VIDEO_CONTENT_NAME_AWS;
export const EMAIL_NO_REPLY_PASS = process.env.EMAIL_PASS;
export const EMAIL_NO_REPLY_USER = process.env.EMAIL_USER;
export const EMAIL_NO_REPLY_SERVICE = process.env.EMAIL_SERVICE;
